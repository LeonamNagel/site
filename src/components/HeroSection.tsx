...
export function HeroSection() {
  ...
  return (
    <section ref={heroRef} className="relative min-h-[60vh] flex items-center justify-center overflow-hidden mb-[-4rem]">
      ...
      <div className="container mx-auto text-center relative z-10">
        ...
        <p className="text-lg sm:text-xl md:text-2xl mb-4 md:mb-6 text-muted-foreground max-w-3xl mx-auto px-2">
